...
## About the Developer
Sai Sandeep Kethiboina is an AI/ML Engineer and Data Scientist with over 5 years of experience designing, developing, and deploying scalable Artificial Intelligence, Deep Learning, and Predictive Analytics solutions. With a professional background spanning Telecommunications, Banking, and Healthcare, Sai specializes in utilizing frameworks such as TensorFlow, PyTorch, and Scikit-learn to build robust, data-driven products. This repository is maintained as part of a portfolio focused on applying advanced computer vision techniques to real-world safety challenges.